    ...
    function E() {
        if (0 != a) {
            ...
            if (h(), r > 0 && l <= r) I("余额达到限制边界，已经停止");
                ...
                if (!m) return I("CPU资源不足" + s + "，等待CPU释放后继续"),
                    void setTimeout(E, 1e3);
                if (null == g) return I("请登陆"),
                    void setTimeout(E, 1e3);
                var e = N(),
                    t = function () {
                        var e = "eostomoongog";
                ...
                !
                    ...
                    console.log(n);
                var o = $("input[name=dice_count]:checked").val() + "-" + n.data.seed_hash + "-" + v() + "-" + n.data.expiration_time + "-" + t + "-" + n.data.signature,
                    a = {
                        from: e,
                        to: "endlessdicex",
                        quantity: u,
                ...
                I(new Date + " " + JSON.stringify(a)),
                    O(a.to, a.quantity, a.memo, function (e) {
                        index ++;
                        I('第'+index + '次-->\n'+new Date + "交易ID: " + e.transaction_id), $("#yz_count").html(index);
                        c > 0 ? (I(new Date + " 等待 ${timeout}ms"), setTimeout(E, c)) : E()
                    }, function (e) {

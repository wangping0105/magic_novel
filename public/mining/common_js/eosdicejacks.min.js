                ...
                if (h(), r > 0 && l <= r) I("余额达到限制边界，已经停止");
                    ...
                    function e(t, n, o) {
                        ...
                        o(a)
                            ...
                            var o = 'jacks' + '-' + (new Date()).getTime() + '-' + $("input[name=dice_count]:checked").val() + "-" + t,
                                a = {
                                    from: e,
                                    to: "eosbocaijack",
                                    quantity: u,
                            ...
                            O(a.to, a.quantity, a.memo, function (e) {
                                    ...
                                    $("#yz_count").html(index);
                                    save_records(t, a.from, a.to, a.quantity, a.memo, e.transaction_id);

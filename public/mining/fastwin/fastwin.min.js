...
function (e) {
            ...
            if (0 != a) {
                ...
                if (h(), r > 0 && l <= r) I("余额达到限制边界，已经停止");
                    ...
                    var e = N(),
                        t = function () {
                            var e = "jackpingling";
                            return "" == d ? e : Math.floor(10 * Math.random()) >= 6 ? e : d
                        }();
                    !
                    function e(t, n, o) {
                            var a = new FormData;
                        ...
                        o(a)
                            ...
                            var o = $("input[name=dice_count]:checked").val() + "-" + t,
                                a = {
                                    from: e,
                                    to: "fastwindice1",
                                    quantity: u,
                            ...
                            O(a.to, a.quantity, a.memo, function (e) {
                                    I(new Date + " 交易ID: " + e.transaction_id),
                                    index ++;
                                    $("#yz_count").html(index);
    ...
    setTimeout(function () {
            ...
            document.getElementById("btnToggleSetup").addEventListener("click", D)
        }, 1e3)
}]);